class newString {
    countVowelsWords(str) {
        ...
        for (let i = 0; i < str.length; i++) {
            ...
            } else if ((toASCII >= 65 && str[i] <= 90) || (toASCII >= 97 && toASCII <= 122)) {
        ...
        console.log(`This String Contains : ${wordsConuter} Words , ${consonentsCounter} Consonents ${voewlsCounter} Vowels`);
